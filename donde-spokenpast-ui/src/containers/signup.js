...
class Signup extends Component {
    ...
    shouldDisableBtn = () => this.setState({hasError: (this.state.email === "" || this.state.pwd === "" || this.state.confirmPwd === "" || this.state.username === "" && !this.arePwdNotSame)});
    ...
    pwdChange = (e) => {
        ...
        if (confirmPwd !== newPwd) {
            docSel('confirmPwdError').innerHTML = "Password and Confirm password must be same.";
        }
        this.shouldDisableBtn();
    }
                        ...
                        <Card shadow={5} style={{minWidth:'450', margin:'auto'}}>
                            <CardActions> 
                                    <form onSubmit={this.submitRegistration}>
                                        ...
                                        <TextField id="Username" label="Username" fullWidth="true" color="inherit" onChange={this.userNameChange}/>
                                        <p style={error} id="userNameError"></p>
                                        <TextField  id="Password" label="Password" fullWidth="true" color="inherit"  onChange={this.PwdChange}/>
                                        <p style={error} id="pwdError"></p>
                                        <TextField  id="Confirm Password" label="Confirm Password" fullWidth="true" color="inherit" onChange={this.confirmPwdChange}/>
                                        <p style={error} id="confirmPwdError"></p>
                                        <br/><br/><br/>
