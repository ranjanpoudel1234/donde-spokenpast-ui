                        ...
                        <Card shadow={5} style={{minWidth:'450', margin:'auto'}}>
                            <CardActions> 
                                    <form onSubmit={this.submitRegistration}>
                                        ...
                                        <TextField floatingLabelText={`Username`} onChange={this.userNameChange} />
                                        <p style={error} id="userNameError"></p>
                                        <TextField password floatingLabelText={`Password`} onChange={this.pwdChange} />
                                        <p style={error} id="pwdError"></p>
                                        <TextField floatingLabelText={`Confirm Password`} onChange={this.confirmPwdChange} />
